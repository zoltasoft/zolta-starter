...
use App\Services\UserManagementService\Application\Queries\Identity\ReadIdentityInstallation\ReadIdentityInstallationQuery;
use InvalidArgumentException;
use Zolta\Cqrs\Services\Pipeline\ApplicationService;
use Zolta\Support\Application\Attributes\AsApplicationService;

#[AsApplicationService]
final readonly class ReadIdentityInstallationService
{
    ...
    public function __invoke(IdentityOperationDTO $dto): mixed
    {
        ['result' => $result] = $this->applicationService->runAndCapture(
            ReadIdentityInstallationQuery::class,
            [
