...
useSeoMeta({ title: () => `${copy.value.legal.privacyTitle} · ${copy.value.brand}` })
</script>

<template>
  <UContainer class="max-w-4xl py-16 sm:py-24">
    ...
    <UAlert
      ...
      variant="subtle"
      icon="i-lucide-info"
      :description="copy.legal.notice"
      class="mt-8"
    />
    <div class="mt-12 space-y-10">
      <section
        v-for="section in copy.legal.privacy"
        :key="section.title"
      >
